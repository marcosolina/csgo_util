 ...
 */
@FieldNameConstants
public class CmdGetPlayersAvgScorePerMap implements WebCommandRequest<RestPlayersAvgScoresPerMap> {
	...
	public CmdGetPlayersAvgScorePerMap(List<String> steamIds, String scoreType, List<String> maps, String matchesToConsider) {
		super();
