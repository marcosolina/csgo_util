...
public class Entry_kill_stats_extended_cacheDao extends IxigoDao<Entry_kill_stats_extended_cacheDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Entry_kill_stats_extended_cacheDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "entry_kill_stats_extended_cache";
	private Entry_kill_stats_extended_cacheDto dto = null;

	public Entry_kill_stats_extended_cacheDao() {
		_LOGGER.trace("Instanciating Entry_kill_stats_extended_cacheDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlAutoincrementalFiles(new ArrayList<String>());
		this.setSqlFields(new String[] {
			Entry_kill_stats_extended_cacheDto.Fields.total_rounds_t,
			Entry_kill_stats_extended_cacheDto.Fields.ekct_success,
			Entry_kill_stats_extended_cacheDto.Fields.ekt_attempts,
			Entry_kill_stats_extended_cacheDto.Fields.ekt_success,
			Entry_kill_stats_extended_cacheDto.Fields.ekct_attempts,
			Entry_kill_stats_extended_cacheDto.Fields.total_rounds,
			Entry_kill_stats_extended_cacheDto.Fields.ekct_success_rate_overall,
			Entry_kill_stats_extended_cacheDto.Fields.ekt_success_rate,
			Entry_kill_stats_extended_cacheDto.Fields.steamid,
			Entry_kill_stats_extended_cacheDto.Fields.ek_success_rate_overall,
			Entry_kill_stats_extended_cacheDto.Fields.ek_success_rate,
			Entry_kill_stats_extended_cacheDto.Fields.total_rounds_ct,
			Entry_kill_stats_extended_cacheDto.Fields.ek_success,
			Entry_kill_stats_extended_cacheDto.Fields.ekct_success_rate,
			Entry_kill_stats_extended_cacheDto.Fields.ek_attempts,
			Entry_kill_stats_extended_cacheDto.Fields.ekt_success_rate_overall,
		});
		// @formatter:on
		this.dto = new Entry_kill_stats_extended_cacheDto();
	}

	@Override
	public Entry_kill_stats_extended_cacheDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Entry_kill_stats_extended_cacheDto(), row, rowMetaData);
	}
	...
	public Entry_kill_stats_extended_cacheDto getDto() {
		return this.dto;
	}

	public void setDto(Entry_kill_stats_extended_cacheDto dto) {
		this.dto = dto;
	}
