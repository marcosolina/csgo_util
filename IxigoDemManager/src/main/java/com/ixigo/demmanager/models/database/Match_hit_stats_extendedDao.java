...
public class Match_hit_stats_extendedDao extends IxigoDao<Match_hit_stats_extendedDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Match_hit_stats_extendedDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "match_hit_stats_extended";
	...
	// @formatter:off
		...
		this.setSqlFields(new String[] {
			...
			Match_hit_stats_extendedDto.Fields.hits,
			Match_hit_stats_extendedDto.Fields.stomach_hits,
	...
	public Match_hit_stats_extendedDto getDto() {
		return this.dto;
	}

	public void setDto(Match_hit_stats_extendedDto dto) {
		this.dto = dto;
	}
