...
public class Match_player_weapon_stats_cacheDao extends IxigoDao<Match_player_weapon_stats_cacheDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Match_player_weapon_stats_cacheDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "match_player_weapon_stats_cache";
	private Match_player_weapon_stats_cacheDto dto = null;

	public Match_player_weapon_stats_cacheDao() {
		_LOGGER.trace("Instanciating Match_player_weapon_stats_cacheDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlAutoincrementalFiles(new ArrayList<String>());
		this.setSqlFields(new String[] {
			Match_player_weapon_stats_cacheDto.Fields.kills,
			Match_player_weapon_stats_cacheDto.Fields.headshotkills,
			Match_player_weapon_stats_cacheDto.Fields.damage_per_shot,
			Match_player_weapon_stats_cacheDto.Fields.match_id,
			Match_player_weapon_stats_cacheDto.Fields.accuracy,
			Match_player_weapon_stats_cacheDto.Fields.steamid,
			Match_player_weapon_stats_cacheDto.Fields.hits,
			Match_player_weapon_stats_cacheDto.Fields.weapon,
			Match_player_weapon_stats_cacheDto.Fields.total_damage,
			Match_player_weapon_stats_cacheDto.Fields.damage_per_hit,
			Match_player_weapon_stats_cacheDto.Fields.headshotkills_percentage,
			Match_player_weapon_stats_cacheDto.Fields.shots_fired,
			Match_player_weapon_stats_cacheDto.Fields.chest_hit_percentage,
			Match_player_weapon_stats_cacheDto.Fields.leg_hit_percentage,
			Match_player_weapon_stats_cacheDto.Fields.headshot_percentage,
			Match_player_weapon_stats_cacheDto.Fields.stomach_hit_percentage,
			Match_player_weapon_stats_cacheDto.Fields.username,
			Match_player_weapon_stats_cacheDto.Fields.arm_hit_percentage,
		});
		// @formatter:on
		this.dto = new Match_player_weapon_stats_cacheDto();
	}

	@Override
	public Match_player_weapon_stats_cacheDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Match_player_weapon_stats_cacheDto(), row, rowMetaData);
	}
	...
	public Match_player_weapon_stats_cacheDto getDto() {
		return this.dto;
	}

	public void setDto(Match_player_weapon_stats_cacheDto dto) {
		this.dto = dto;
	}
