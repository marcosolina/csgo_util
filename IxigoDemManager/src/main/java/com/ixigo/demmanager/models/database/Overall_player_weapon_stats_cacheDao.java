...
public class Overall_player_weapon_stats_cacheDao extends IxigoDao<Overall_player_weapon_stats_cacheDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Overall_player_weapon_stats_cacheDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "overall_player_weapon_stats_cache";
	private Overall_player_weapon_stats_cacheDto dto = null;

	public Overall_player_weapon_stats_cacheDao() {
		_LOGGER.trace("Instanciating Overall_player_weapon_stats_cacheDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlAutoincrementalFiles(new ArrayList<String>());
		this.setSqlFields(new String[] {
			Overall_player_weapon_stats_cacheDto.Fields.kills,
			Overall_player_weapon_stats_cacheDto.Fields.headshotkills,
			Overall_player_weapon_stats_cacheDto.Fields.damage_per_shot,
			Overall_player_weapon_stats_cacheDto.Fields.accuracy,
			Overall_player_weapon_stats_cacheDto.Fields.steamid,
			Overall_player_weapon_stats_cacheDto.Fields.hits,
			Overall_player_weapon_stats_cacheDto.Fields.weapon,
			Overall_player_weapon_stats_cacheDto.Fields.total_damage,
			Overall_player_weapon_stats_cacheDto.Fields.damage_per_hit,
			Overall_player_weapon_stats_cacheDto.Fields.headshotkills_percentage,
			Overall_player_weapon_stats_cacheDto.Fields.shots_fired,
			Overall_player_weapon_stats_cacheDto.Fields.chest_hit_percentage,
			Overall_player_weapon_stats_cacheDto.Fields.leg_hit_percentage,
			Overall_player_weapon_stats_cacheDto.Fields.headshot_percentage,
			Overall_player_weapon_stats_cacheDto.Fields.stomach_hit_percentage,
			Overall_player_weapon_stats_cacheDto.Fields.arm_hit_percentage,
		});
		// @formatter:on
		this.dto = new Overall_player_weapon_stats_cacheDto();
	}

	@Override
	public Overall_player_weapon_stats_cacheDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Overall_player_weapon_stats_cacheDto(), row, rowMetaData);
	}
	...
	public Overall_player_weapon_stats_cacheDto getDto() {
		return this.dto;
	}

	public void setDto(Overall_player_weapon_stats_cacheDto dto) {
		this.dto = dto;
	}
