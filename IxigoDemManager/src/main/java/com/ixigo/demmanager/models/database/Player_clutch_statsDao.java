...
public class Player_clutch_statsDao extends IxigoDao<Player_clutch_statsDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Player_clutch_statsDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "player_clutch_stats";
	private Player_clutch_statsDto dto = null;

	public Player_clutch_statsDao() {
		_LOGGER.trace("Instanciating Player_clutch_statsDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlFields(new String[] {
			Player_clutch_statsDto.Fields._1v5l,
			Player_clutch_statsDto.Fields._1v2l,
			Player_clutch_statsDto.Fields._1v1l,
			Player_clutch_statsDto.Fields._1v5p,
			Player_clutch_statsDto.Fields._1v4l,
			Player_clutch_statsDto.Fields._1v3l,
			Player_clutch_statsDto.Fields.steamid,
			Player_clutch_statsDto.Fields._1v2p,
			Player_clutch_statsDto.Fields._1vnl,
			Player_clutch_statsDto.Fields._1v1p,
			Player_clutch_statsDto.Fields._1v4p,
			Player_clutch_statsDto.Fields._1v3p,
			Player_clutch_statsDto.Fields._1v5w,
			Player_clutch_statsDto.Fields._1vnp,
			Player_clutch_statsDto.Fields._1v4w,
			Player_clutch_statsDto.Fields._1v1w,
			Player_clutch_statsDto.Fields._1v3w,
			Player_clutch_statsDto.Fields._1v2w,
			Player_clutch_statsDto.Fields._1vnw,
		});
		// @formatter:on
		this.dto = new Player_clutch_statsDto();
	}

	@Override
	public Player_clutch_statsDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Player_clutch_statsDto(), row, rowMetaData);
	}
	...
	public Player_clutch_statsDto getDto() {
		return this.dto;
	}

	public void setDto(Player_clutch_statsDto dto) {
		this.dto = dto;
	}
