...
public class Player_map_stats_extended_cacheDao extends IxigoDao<Player_map_stats_extended_cacheDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Player_map_stats_extended_cacheDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "player_map_stats_extended_cache";
	private Player_map_stats_extended_cacheDto dto = null;

	public Player_map_stats_extended_cacheDao() {
		_LOGGER.trace("Instanciating Player_map_stats_extended_cacheDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlAutoincrementalFiles(new ArrayList<String>());
		this.setSqlFields(new String[] {
			Player_map_stats_extended_cacheDto.Fields.kills,
			Player_map_stats_extended_cacheDto.Fields.ff,
			Player_map_stats_extended_cacheDto.Fields.hltv_rating,
			Player_map_stats_extended_cacheDto.Fields.bd,
			Player_map_stats_extended_cacheDto.Fields._1v3,
			Player_map_stats_extended_cacheDto.Fields._1v2,
			Player_map_stats_extended_cacheDto.Fields.kast,
			Player_map_stats_extended_cacheDto.Fields._1v1,
			Player_map_stats_extended_cacheDto.Fields.hr,
			Player_map_stats_extended_cacheDto.Fields.mapname,
			Player_map_stats_extended_cacheDto.Fields.bp,
			Player_map_stats_extended_cacheDto.Fields.ud,
			Player_map_stats_extended_cacheDto.Fields.rws,
			Player_map_stats_extended_cacheDto.Fields.headshots,
			Player_map_stats_extended_cacheDto.Fields.assists,
			Player_map_stats_extended_cacheDto.Fields._4k,
			Player_map_stats_extended_cacheDto.Fields._2k,
			Player_map_stats_extended_cacheDto.Fields._1v5,
			Player_map_stats_extended_cacheDto.Fields._1v4,
			Player_map_stats_extended_cacheDto.Fields.headshot_percentage,
			Player_map_stats_extended_cacheDto.Fields.deaths,
			Player_map_stats_extended_cacheDto.Fields.ffd,
			Player_map_stats_extended_cacheDto.Fields.ek,
			Player_map_stats_extended_cacheDto.Fields.mvp,
			Player_map_stats_extended_cacheDto.Fields.dpr,
			Player_map_stats_extended_cacheDto.Fields.kpr,
			Player_map_stats_extended_cacheDto.Fields.matches,
			Player_map_stats_extended_cacheDto.Fields.adr,
			Player_map_stats_extended_cacheDto.Fields.steamid,
			Player_map_stats_extended_cacheDto.Fields.td,
			Player_map_stats_extended_cacheDto.Fields.tda,
			Player_map_stats_extended_cacheDto.Fields._5k,
			Player_map_stats_extended_cacheDto.Fields._3k,
			Player_map_stats_extended_cacheDto.Fields.ebt,
			Player_map_stats_extended_cacheDto.Fields.tk,
			Player_map_stats_extended_cacheDto.Fields.kdr,
			Player_map_stats_extended_cacheDto.Fields._1k,
			Player_map_stats_extended_cacheDto.Fields.tdh,
			Player_map_stats_extended_cacheDto.Fields.fbt,
			Player_map_stats_extended_cacheDto.Fields.fa,
			Player_map_stats_extended_cacheDto.Fields.rounds,
		});
		// @formatter:on
		this.dto = new Player_map_stats_extended_cacheDto();
	}

	@Override
	public Player_map_stats_extended_cacheDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Player_map_stats_extended_cacheDto(), row, rowMetaData);
	}
	...
	public Player_map_stats_extended_cacheDto getDto() {
		return this.dto;
	}

	public void setDto(Player_map_stats_extended_cacheDto dto) {
		this.dto = dto;
	}
