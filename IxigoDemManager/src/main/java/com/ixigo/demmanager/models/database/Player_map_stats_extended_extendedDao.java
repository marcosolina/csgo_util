...
public class Player_map_stats_extended_extendedDao extends IxigoDao<Player_map_stats_extended_extendedDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Player_map_stats_extended_extendedDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "player_map_stats_extended_extended";
	private Player_map_stats_extended_extendedDto dto = null;

	public Player_map_stats_extended_extendedDao() {
		_LOGGER.trace("Instanciating Player_map_stats_extended_extendedDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlFields(new String[] {
			Player_map_stats_extended_extendedDto.Fields.kills,
			Player_map_stats_extended_extendedDto.Fields.ff,
			Player_map_stats_extended_extendedDto.Fields.hltv_rating,
			Player_map_stats_extended_extendedDto.Fields.bd,
			Player_map_stats_extended_extendedDto.Fields._1v3,
			...
			Player_map_stats_extended_extendedDto.Fields._2k,
			Player_map_stats_extended_extendedDto.Fields.usernames,
			Player_map_stats_extended_extendedDto.Fields._1v5,
			Player_map_stats_extended_extendedDto.Fields._1v4,
			Player_map_stats_extended_extendedDto.Fields.headshot_percentage,
			Player_map_stats_extended_extendedDto.Fields.deaths,
			Player_map_stats_extended_extendedDto.Fields.wins,
			Player_map_stats_extended_extendedDto.Fields.averagewinscore,
			Player_map_stats_extended_extendedDto.Fields.winlossratio,
			Player_map_stats_extended_extendedDto.Fields.ffd,
			Player_map_stats_extended_extendedDto.Fields.ek,
			Player_map_stats_extended_extendedDto.Fields.mvp,
			Player_map_stats_extended_extendedDto.Fields.dpr,
			Player_map_stats_extended_extendedDto.Fields.kpr,
			Player_map_stats_extended_extendedDto.Fields.matches,
			Player_map_stats_extended_extendedDto.Fields.adr,
			Player_map_stats_extended_extendedDto.Fields.steamid,
			Player_map_stats_extended_extendedDto.Fields.td,
			Player_map_stats_extended_extendedDto.Fields.tda,
			Player_map_stats_extended_extendedDto.Fields._5k,
			Player_map_stats_extended_extendedDto.Fields._3k,
			Player_map_stats_extended_extendedDto.Fields.ebt,
			Player_map_stats_extended_extendedDto.Fields.tk,
			Player_map_stats_extended_extendedDto.Fields.kdr,
			Player_map_stats_extended_extendedDto.Fields._1k,
			Player_map_stats_extended_extendedDto.Fields.tdh,
			Player_map_stats_extended_extendedDto.Fields.fbt,
			Player_map_stats_extended_extendedDto.Fields.fa,
			Player_map_stats_extended_extendedDto.Fields.rounds,
		});
		// @formatter:on
		this.dto = new Player_map_stats_extended_extendedDto();
	}

	@Override
	public Player_map_stats_extended_extendedDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Player_map_stats_extended_extendedDto(), row, rowMetaData);
	}
	...
	public Player_map_stats_extended_extendedDto getDto() {
		return this.dto;
	}

	public void setDto(Player_map_stats_extended_extendedDto dto) {
		this.dto = dto;
	}
