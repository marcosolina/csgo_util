...
public class Player_match_results_cacheDao extends IxigoDao<Player_match_results_cacheDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Player_match_results_cacheDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "player_match_results_cache";
	private Player_match_results_cacheDto dto = null;

	public Player_match_results_cacheDao() {
		_LOGGER.trace("Instanciating Player_match_results_cacheDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlAutoincrementalFiles(new ArrayList<String>());
		this.setSqlFields(new String[] {
			Player_match_results_cacheDto.Fields.rounds_on_team2,
			Player_match_results_cacheDto.Fields.rounds_on_team1,
			Player_match_results_cacheDto.Fields.team1_wins_as_ct,
			Player_match_results_cacheDto.Fields.match_id,
			Player_match_results_cacheDto.Fields.total_t_wins,
			Player_match_results_cacheDto.Fields.match_date,
			Player_match_results_cacheDto.Fields.steamid,
			Player_match_results_cacheDto.Fields.score_against,
			Player_match_results_cacheDto.Fields.match_result,
			Player_match_results_cacheDto.Fields.score_for,
			Player_match_results_cacheDto.Fields.last_round_team,
			Player_match_results_cacheDto.Fields.team2_wins_as_ct,
			Player_match_results_cacheDto.Fields.team2_wins_as_t,
			Player_match_results_cacheDto.Fields.total_ct_wins,
			Player_match_results_cacheDto.Fields.team1_wins_as_t,
		});
		// @formatter:on
		this.dto = new Player_match_results_cacheDto();
	}

	@Override
	public Player_match_results_cacheDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Player_match_results_cacheDto(), row, rowMetaData);
	}
	...
	public Player_match_results_cacheDto getDto() {
		return this.dto;
	}

	public void setDto(Player_match_results_cacheDto dto) {
		this.dto = dto;
	}
