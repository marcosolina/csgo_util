...
public class Player_match_statsDao extends IxigoDao<Player_match_statsDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Player_match_statsDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "player_match_stats";
	...
	public Player_match_statsDao() {
		...
		this.setSqlFields(new String[] {
			...
			Player_match_statsDto.Fields.ff,
			Player_match_statsDto.Fields.bd,
			Player_match_statsDto.Fields._1v3,
			Player_match_statsDto.Fields._1v2,
			Player_match_statsDto.Fields._1v1,
			Player_match_statsDto.Fields.hr,
			Player_match_statsDto.Fields.match_date,
			Player_match_statsDto.Fields.bp,
			Player_match_statsDto.Fields.ud,
			Player_match_statsDto.Fields.kasttotal,
			Player_match_statsDto.Fields.score,
			Player_match_statsDto.Fields.headshots,
			Player_match_statsDto.Fields.assists,
			Player_match_statsDto.Fields._4k,
			Player_match_statsDto.Fields._2k,
			Player_match_statsDto.Fields.usernames,
			Player_match_statsDto.Fields._1v5,
			Player_match_statsDto.Fields._1v4,
			Player_match_statsDto.Fields.headshot_percentage,
			Player_match_statsDto.Fields.deaths,
			Player_match_statsDto.Fields.ffd,
			...
			Player_match_statsDto.Fields.tk,
			Player_match_statsDto.Fields.kdr,
			Player_match_statsDto.Fields._1k,
			Player_match_statsDto.Fields.tdh,
	...
	public Player_match_statsDto getDto() {
		return this.dto;
	}

	public void setDto(Player_match_statsDto dto) {
		this.dto = dto;
	}
