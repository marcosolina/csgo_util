...
public class Player_match_stats_extended_cacheDao extends IxigoDao<Player_match_stats_extended_cacheDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Player_match_stats_extended_cacheDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "player_match_stats_extended_cache";
	private Player_match_stats_extended_cacheDto dto = null;

	public Player_match_stats_extended_cacheDao() {
		_LOGGER.trace("Instanciating Player_match_stats_extended_cacheDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlAutoincrementalFiles(new ArrayList<String>());
		this.setSqlFields(new String[] {
			Player_match_stats_extended_cacheDto.Fields.kills,
			Player_match_stats_extended_cacheDto.Fields.ff,
			Player_match_stats_extended_cacheDto.Fields.hltv_rating,
			Player_match_stats_extended_cacheDto.Fields.bd,
			Player_match_stats_extended_cacheDto.Fields._1v3,
			Player_match_stats_extended_cacheDto.Fields._1v2,
			Player_match_stats_extended_cacheDto.Fields.kast,
			Player_match_stats_extended_cacheDto.Fields._1v1,
			Player_match_stats_extended_cacheDto.Fields.hr,
			Player_match_stats_extended_cacheDto.Fields.match_date,
			Player_match_stats_extended_cacheDto.Fields.bp,
			Player_match_stats_extended_cacheDto.Fields.ud,
			Player_match_stats_extended_cacheDto.Fields.kasttotal,
			Player_match_stats_extended_cacheDto.Fields.rws,
			Player_match_stats_extended_cacheDto.Fields.score,
			Player_match_stats_extended_cacheDto.Fields.headshots,
			Player_match_stats_extended_cacheDto.Fields.assists,
			Player_match_stats_extended_cacheDto.Fields._4k,
			Player_match_stats_extended_cacheDto.Fields.last_round_team,
			Player_match_stats_extended_cacheDto.Fields._2k,
			Player_match_stats_extended_cacheDto.Fields.usernames,
			Player_match_stats_extended_cacheDto.Fields._1v5,
			Player_match_stats_extended_cacheDto.Fields._1v4,
			Player_match_stats_extended_cacheDto.Fields.headshot_percentage,
			Player_match_stats_extended_cacheDto.Fields.deaths,
			Player_match_stats_extended_cacheDto.Fields.rounds_on_team2,
			Player_match_stats_extended_cacheDto.Fields.rounds_on_team1,
			Player_match_stats_extended_cacheDto.Fields.ffd,
			Player_match_stats_extended_cacheDto.Fields.roundsplayed,
			Player_match_stats_extended_cacheDto.Fields.ek,
			Player_match_stats_extended_cacheDto.Fields.mvp,
			Player_match_stats_extended_cacheDto.Fields.match_id,
			Player_match_stats_extended_cacheDto.Fields.dpr,
			Player_match_stats_extended_cacheDto.Fields.rwstotal,
			Player_match_stats_extended_cacheDto.Fields.kpr,
			Player_match_stats_extended_cacheDto.Fields.adr,
			Player_match_stats_extended_cacheDto.Fields.steamid,
			Player_match_stats_extended_cacheDto.Fields.td,
			Player_match_stats_extended_cacheDto.Fields.tda,
			Player_match_stats_extended_cacheDto.Fields._5k,
			Player_match_stats_extended_cacheDto.Fields._3k,
			Player_match_stats_extended_cacheDto.Fields.ebt,
			Player_match_stats_extended_cacheDto.Fields.tk,
			Player_match_stats_extended_cacheDto.Fields.kdr,
			Player_match_stats_extended_cacheDto.Fields._1k,
			Player_match_stats_extended_cacheDto.Fields.tdh,
			Player_match_stats_extended_cacheDto.Fields.fbt,
			Player_match_stats_extended_cacheDto.Fields.fa,
		});
		// @formatter:on
		this.dto = new Player_match_stats_extended_cacheDto();
	}

	@Override
	public Player_match_stats_extended_cacheDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Player_match_stats_extended_cacheDto(), row, rowMetaData);
	}
	...
	public Player_match_stats_extended_cacheDto getDto() {
		return this.dto;
	}

	public void setDto(Player_match_stats_extended_cacheDto dto) {
		this.dto = dto;
	}
