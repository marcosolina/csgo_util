...
public class Player_overall_stats_extendedDao extends IxigoDao<Player_overall_stats_extendedDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Player_overall_stats_extendedDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "player_overall_stats_extended";
	...
	public Player_overall_stats_extendedDao() {
		...
		this.setSqlFields(new String[] {
			...
			Player_overall_stats_extendedDto.Fields.ff,
			Player_overall_stats_extendedDto.Fields.hltv_rating,
			Player_overall_stats_extendedDto.Fields.bd,
			Player_overall_stats_extendedDto.Fields._1v3,
			Player_overall_stats_extendedDto.Fields._1v2,
			Player_overall_stats_extendedDto.Fields.kast,
			Player_overall_stats_extendedDto.Fields._1v1,
			Player_overall_stats_extendedDto.Fields.hr,
			Player_overall_stats_extendedDto.Fields.bp,
			Player_overall_stats_extendedDto.Fields.ud,
			Player_overall_stats_extendedDto.Fields.rws,
			Player_overall_stats_extendedDto.Fields.headshots,
			...
			Player_overall_stats_extendedDto.Fields.deaths,
			Player_overall_stats_extendedDto.Fields.ffd,
			Player_overall_stats_extendedDto.Fields.ek,
			Player_overall_stats_extendedDto.Fields.mvp,
			Player_overall_stats_extendedDto.Fields.dpr,
			Player_overall_stats_extendedDto.Fields.kpr,
			Player_overall_stats_extendedDto.Fields.matches,
			Player_overall_stats_extendedDto.Fields.adr,
			Player_overall_stats_extendedDto.Fields.steamid,
			Player_overall_stats_extendedDto.Fields.td,
			Player_overall_stats_extendedDto.Fields.tda,
			Player_overall_stats_extendedDto.Fields._5k,
			Player_overall_stats_extendedDto.Fields._3k,
			Player_overall_stats_extendedDto.Fields.ebt,
			Player_overall_stats_extendedDto.Fields.tk,
			Player_overall_stats_extendedDto.Fields.kdr,
			Player_overall_stats_extendedDto.Fields._1k,
			Player_overall_stats_extendedDto.Fields.tdh,
			Player_overall_stats_extendedDto.Fields.fbt,
	...
	public Player_overall_stats_extendedDto getDto() {
		return this.dto;
	}

	public void setDto(Player_overall_stats_extendedDto dto) {
		this.dto = dto;
	}
