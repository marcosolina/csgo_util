...
public class Round_player_weapon_stats_cacheDao extends IxigoDao<Round_player_weapon_stats_cacheDto> {

	private static final Logger _LOGGER = LoggerFactory.getLogger(Round_player_weapon_stats_cacheDao.class);
	private static final long serialVersionUID = 1L;
	public static final String tableName = "round_player_weapon_stats_cache";
	private Round_player_weapon_stats_cacheDto dto = null;

	public Round_player_weapon_stats_cacheDao() {
		_LOGGER.trace("Instanciating Round_player_weapon_stats_cacheDao");
		this.setSqlViewName(tableName);
		// @formatter:off
		this.setSqlKeys(new String[] {  });
		this.setSqlAutoincrementalFiles(new ArrayList<String>());
		this.setSqlFields(new String[] {
			Round_player_weapon_stats_cacheDto.Fields.damage_per_shot,
			Round_player_weapon_stats_cacheDto.Fields.match_id,
			Round_player_weapon_stats_cacheDto.Fields.accuracy,
			Round_player_weapon_stats_cacheDto.Fields.steamid,
			Round_player_weapon_stats_cacheDto.Fields.hits,
			Round_player_weapon_stats_cacheDto.Fields.weapon,
			Round_player_weapon_stats_cacheDto.Fields.total_damage,
			Round_player_weapon_stats_cacheDto.Fields.round,
			Round_player_weapon_stats_cacheDto.Fields.damage_per_hit,
			Round_player_weapon_stats_cacheDto.Fields.shots_fired,
			Round_player_weapon_stats_cacheDto.Fields.chest_hit_percentage,
			Round_player_weapon_stats_cacheDto.Fields.leg_hit_percentage,
			Round_player_weapon_stats_cacheDto.Fields.headshot_percentage,
			Round_player_weapon_stats_cacheDto.Fields.stomach_hit_percentage,
			Round_player_weapon_stats_cacheDto.Fields.username,
			Round_player_weapon_stats_cacheDto.Fields.arm_hit_percentage,
		});
		// @formatter:on
		this.dto = new Round_player_weapon_stats_cacheDto();
	}

	@Override
	public Round_player_weapon_stats_cacheDto mappingFunction(Row row, RowMetadata rowMetaData) {
		_LOGGER.trace("Mapping data");
		return this.genericMappingFunction(new Round_player_weapon_stats_cacheDto(), row, rowMetaData);
	}
	...
	public Round_player_weapon_stats_cacheDto getDto() {
		return this.dto;
	}

	public void setDto(Round_player_weapon_stats_cacheDto dto) {
		this.dto = dto;
	}
