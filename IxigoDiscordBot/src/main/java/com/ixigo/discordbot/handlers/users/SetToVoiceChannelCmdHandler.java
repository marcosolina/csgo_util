...
@Component
public class SetToVoiceChannelCmdHandler implements WebCommandHandler<SetToVoiceChannelCmd, Void> {
	...
	@Override
	public Mono<ResponseEntity<Void>> handle(SetToVoiceChannelCmd cmd) {
