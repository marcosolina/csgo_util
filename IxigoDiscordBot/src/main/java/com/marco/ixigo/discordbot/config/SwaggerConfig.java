...
public class SwaggerConfig {
    ...
    public Docket swaggerConfiguration() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.marco.ixigo.discordbot.controllers"))
    ...
    private ApiInfo apiEndPointsInfo() {
        ...
        return new ApiInfoBuilder()
                .title("Discord Bot")
                .description("This service manages the Discord Bot that we use in our channels")
