...
public class SwaggerConfig {
    @Value("${com.marco.ixigo.rconapiservice.version}")
    ...
    public Docket swaggerConfiguration() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.marco.ixigo.rconapiservice.controllers"))
    ...
    private ApiInfo apiEndPointsInfo() {
        ...
        return new ApiInfoBuilder()
                ...
                .description("This project to send commands to my dedicated CSGO server in a easier way")
