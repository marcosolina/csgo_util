...
import { useGetPlayersAvgScoresPerMap, useGetMapsPlayedCount } from "../../../services/charts";
import { IUsePlayersAvgScoresPerMapDataRequest, IUsePlayersAvgScoresPerMapDataResult } from "./interfaces";
import { IxigoPossibleValue } from "../../../common";

export const useAvgScoresPerMapData = (
  request: IUsePlayersAvgScoresPerMapDataRequest
): IUsePlayersAvgScoresPerMapDataResult => {
  const qAvgScores = useGetPlayersAvgScoresPerMap({
