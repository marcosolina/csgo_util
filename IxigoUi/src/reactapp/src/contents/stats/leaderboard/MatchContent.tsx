...
const MatchContent: React.FC<MatchContentProps> = () => {
  const { data, isError, isFetching, isLoading, refetch } = useQuery({
    queryKey: ["matches"],
    queryFn: async () => {
      const url1 = new URL(`${SERVICES_URLS["dem-manager"]["get-stats"]}MATCH_RESULTS_CACHE`);
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: "team1_total_wins",
        header: "",
        enableColumnActions: false,
        size: smallColSize,
        Header: createCustomHeader("Team 1 Round Wins"),
        enableGrouping: false,
        enableFilter: false,
        Cell: ({ cell }: { cell: any }) => {
      ...
      {
        accessorKey: "team2_total_wins",
        header: "",
        enableColumnActions: false,
        size: smallColSize,
        Header: createCustomHeader("Team 2 Round Wins"),
        enableGrouping: false,
        enableFilter: false,
        Cell: ({ cell }: { cell: any }) => {
          const score = cell.getValue() as number;
      ...
      {
        accessorKey: "total_t_wins",
        header: "T Wins",
        size: smallColSize,
        Header: createCustomHeader("Total Terrorist Wins"),
        enableGrouping: false,
        enableFilter: false,
      ...
      {
        accessorKey: "total_ct_wins",
        header: "CT Wins",
        size: smallColSize,
        Header: createCustomHeader("Total Counter Terrorist Wins"),
        enableGrouping: false,
        enableFilter: false,
        aggregationFn: "mean" as any,
