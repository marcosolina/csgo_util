...
const PlayerWeaponsContent: React.FC<PlayerWeaponProps> = ({ steamid }) => {
  ...
  const columns = useMemo<MRT_ColumnDef<WeaponData>[]>(
    () => [
      ...
      {
        accessorKey: "kills" as const,
        header: "K",
        size: smallColSize,
        Header: createCustomHeader("Total kills"),
        filterVariant: "text",
      ...
      {
        accessorKey: "hits" as const,
        header: "HITS",
        size: smallColSize,
        Header: createCustomHeader("Total hits"),
        filterVariant: "text",
        filterFn: "greaterThan",
      },
      {
      ...
      },
      {
        ...
        header: "HHP",
        size: smallColSize,
        Header: createCustomHeader("Head hit percentage"),
        Cell: ({ cell, row }: { cell: any; row: { index: number } }) => {
          return <PieChartMini percentage={cell.getValue()} color="darkturquoise" size={22} />;
        },
      },
